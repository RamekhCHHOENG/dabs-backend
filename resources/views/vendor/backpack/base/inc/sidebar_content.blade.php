...
<li class="nav-item nav-dropdown">
    <a class="nav-link nav-dropdown-toggle" href="#"><i class="nav-icon la la-users"></i> Partical List</a>
    <ul class="nav-dropdown-items">
        ...
        <li class="nav-item"><a class="nav-link" href="{{ backpack_url('specialty') }}"><i class="nav-icon la la-question"></i> Specialties</a></li>
    </ul>
</li>
<li class="nav-item nav-dropdown">
